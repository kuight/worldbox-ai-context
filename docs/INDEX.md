...
| `STATE-BRIEF.md` | 参谋侧恢复指挥速览（★Z0 当前状态：停点 **Z-7/Z-8 收尾** / 阻塞 B-21R 待重算 / S-1.1 已坐实 / **D-040 生效、D-033 作废** / 临时判据集与待重算清单） | 18936 | R4-V |
| `RUNNER-HANDOFF.md` | 执行侧换对话恢复用（当前任务书/动过的文件/闸门/缺陷登记） | 35084 | R4-V |
...
| `SESSION-LOG/2026-09-22-R4-V.md` | R4-V 段：V-3 证据回灌 + C-3 复核 + Y-3.2 采样 + **Z 段前置未决假说 S-1.1~S-1.5** | 102643 | R4-V |
