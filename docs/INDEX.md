...
| `DECISIONS.md` | 决策与排除项（ADR 风格，只增不删；D-001~D-039） | 32604 | R4-V |
| `MEMORY.md` | 长期记忆，每轮累加的恢复依据（§1~§28，含组件哈希与实机结论） | 53895 | R4-V |
| `STATE-BRIEF.md` | 参谋侧恢复指挥速览（★Z0 当前状态：停点 Z-1 / 阻塞 B-21R / 假说 S-1.1~S-1.3 / 判据集现状 / 放行 Z-5） | 14596 | R4-V |
| `RUNNER-HANDOFF.md` | 执行侧换对话恢复用（当前任务书/动过的文件/闸门/缺陷登记） | 32554 | R4-V |
...
| `SESSION-LOG/2026-09-22-R4-V.md` | R4-V 段：V-3 证据回灌 + C-3 复核 + Y-3.2 采样 + **Z 段前置未决假说 S-1.1~S-1.5** | 87593 | R4-V |
