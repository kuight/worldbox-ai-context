...
| `DECISIONS.md` | 决策与排除项（ADR 风格，只增不删；D-001~D-030） | 25344 | R4-3 |
| `MEMORY.md` | 长期记忆，每轮累加的恢复依据（§1~§27，含组件哈希与实机结论） | 49384 | R4-3 |
| `STATE-BRIEF.md` | 参谋侧恢复指挥速览（环境栈/可行性/风险，整份粘贴用） | 3323 | R0 |
| `RUNNER-HANDOFF.md` | 执行侧换对话恢复用（当前任务书/动过的文件/闸门） | 2122 | R4-3 |
