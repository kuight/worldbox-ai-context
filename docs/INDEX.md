...
| `DECISIONS.md` | 决策与排除项（ADR 风格，只增不删；D-001~D-041，其中 **D-033 已作废**、D-040/D-041 生效） | 36221 | R4-V |
| `MEMORY.md` | 长期记忆，每轮累加的恢复依据（§1~§28，含组件哈希与实机结论） | 53895 | R4-V |
| `STATE-BRIEF.md` | 参谋侧恢复指挥速览（★Z0 当前状态：停点 **Z-5 收尾** / **项目当前无阻塞项**（B-21R 降为历史事件·不可判定）/ S-1.1 已坐实 / **D-040、D-041 生效**、D-033 作废 / 183 用例全绿） | 21886 | R4-V |
| `RUNNER-HANDOFF.md` | 执行侧换对话恢复用（当前任务书/动过的文件/闸门/缺陷登记） | 36434 | R4-V |
...
| `Y-TASKBOOK.md` | Y 段任务书拆档结果（**已补发并逐字落盘**：来源「用户自旧对话复制」；含 §1~§4 首次检索「未找到」证据 + §5 补发原文 + §6 记忆未核实节） | 24345 | R4-V |
| `Z-TASKBOOK.md` | Z 段任务书逐字副本（= SESSION-LOG/2026-09-22-R4-V.md 第 643~767 行，段 SHA-256 61fb1186…；Z-3.0d 补入镜像） | 10095 | R4-V |
...
| `SESSION-LOG/2026-09-22-R4-V.md` | R4-V 段：V-3 证据回灌 + C-3 复核 + Y-3.2 采样 + **Z 段前置未决假说 S-1.1~S-1.5** | 111653 | R4-V |
